...
export declare class DirectiveDependency extends Dependency {
    ...
    constructor(key: Key, optional: boolean, lowerBoundVisibility: Object, upperBoundVisibility: Object, properties: List<any>, attributeName: string, queryDecorator: Query);
    _verify(): void;
...
export declare class DirectiveBinding extends ResolvedBinding {
    resolvedBindings: List<ResolvedBinding>;
    resolvedViewBindings: List<ResolvedBinding>;
    metadata: DirectiveMetadata;
    constructor(key: Key, factory: Function, dependencies: List<Dependency>, resolvedBindings: List<ResolvedBinding>, resolvedViewBindings: List<ResolvedBinding>, metadata: DirectiveMetadata);
...
export declare class ProtoElementInjector {
    ...
    private static _createBindingsWithVisibility(dirBindings, bd, firstBindingIsComponent);
    private static _createBindingWithVisibility(firstBindingIsComponent, dirBinding, dirBindings, binding);
    private static _createViewBindingsWithVisibility(bindings, bd);
