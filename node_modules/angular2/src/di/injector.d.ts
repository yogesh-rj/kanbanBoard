...
export declare class Injector {
    ...
    */
    ...
    _getByKeyHost(key: Key, optional: boolean, bindingVisibility: number, lowerBoundVisibility: Object): any;
    _getPrivateDependency(key: Key, optional: boolean, inj: Injector): any;
    _getByKeyDefault(key: Key, optional: boolean, bindingVisibility: number, lowerBoundVisibility: Object): any;
    displayName: string;
    toString(): string;
}
