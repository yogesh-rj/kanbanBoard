...
var DirectiveBinding = (function (_super) {
    ...
    DirectiveBinding.createFromBinding = function (binding, ann) {
        ...
        var resolvedViewBindings = ann instanceof annotations_1.Component && lang_1.isPresent(ann.viewBindings) ?
            di_1.Injector.resolve(ann.viewBindings) :
            [];
...
var ProtoElementInjector = (function () {
    ...
    ProtoElementInjector._createViewBindingsWithVisibility = function (bindings, bd) {
        var db = bindings[0];
        collection_1.ListWrapper.forEach(db.resolvedViewBindings, function (b) { return bd.push(new injector_1.BindingWithVisibility(b, di_1.PRIVATE)); });
    };
...
var ElementInjector = (function (_super) {
    ...
    ElementInjector.prototype.unlink = function () {
        ...
        var nonViewQueries = collection_1.ListWrapper.filter(queriesToUpdate, function (q) { return !q.query.isViewQuery; });
        collection_1.ListWrapper.forEach(nonViewQueries, function (q) { return q.update(); });
    };
